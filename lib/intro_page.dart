      ...
      Column(
        ...
        children: [
          ...
          getGenderCell(setState, Constants.actionMale.obs, "male.svg",
              S.of(context).male.obs, "#DEF5FF".toColor()),
          SizedBox(
            height: 20.h,
          ),
          getGenderCell(setState, Constants.actionFemale.obs, "female.svg",
              S.of(context).female.obs, "#FFEBEB".toColor()),
          SizedBox(
            height: 20.h,
          ),
        ],
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ConstantWidget.getTextWidget(s.value.toString(), Colors.black,
                    TextAlign.left, FontWeight.w700, 17.sp),
              ],
            ),
          ),
        ),
